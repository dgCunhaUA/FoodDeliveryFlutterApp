    ...
    return BlocListener<CartBloc, CartState>(
      listener: (context, state) {
        ...
        if (state.cartManageStatus is CartSubmitSuccess) {
          _showSnackBar(
              context, "Pedido encomendado com sucesso ", Colors.green);
        } else if (state.cartManageStatus is CartSubmitFailed) {
          _showSnackBar(context, "Erro ao encomendar pedido", Colors.red);
        }
      },
